...
urlpatterns = [
    ...
    path('create-bot/rsi/<int:length>/<int:overbought_level>/<int:oversold_level>/<str:dataframe>/<str:backtest_period', views.rsi_bot, name='create-bot-rsi'),
    path('create-bot/momentum', views.momentum_bot, name='create-bot-momentum'),
    path('create-bot/candlesticks', views.candlesticks_bot, name='create-bot-candlesticks')
