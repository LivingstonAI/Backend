...
urlpatterns = [
    ...
    path('save-new-trade-model/<int:model_id>/<int:initial_equity>/<int:order_ticket>/<str:asset>/<str:volume>/<str:type_of_trade>', views.save_new_trade_model, name='save-new-trade-model'),
