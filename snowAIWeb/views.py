...
def reflections_summary(request, asset):
    try:
        ...
        livingston_reflections_summary = chat_gpt(f'My name is Tlotlo Motingwe (21 years old). Please provide me a summary of my reflections for {asset}. Here is the data: {reflections_list}')
