            ...
            if quarterly_income is not None and not quarterly_income.empty:
                ...
                for col in quarterly_income.columns[:8]:  # Last 8 quarters
                    ...
                    earnings_data.append({
                        ...
                        'revenue': float(revenue) if revenue is not None and str(revenue) != 'nan' else None,
                        'earnings': float(earnings) if earnings is not None and str(earnings) != 'nan' else None
                    })
        except Exception as e:
